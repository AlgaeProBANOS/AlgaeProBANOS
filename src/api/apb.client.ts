...
export interface Species {
  ...
  color: string;
  commonName: string;
  companiesAndProducts: string | null;
  coordinates: string | null;
  depthRange: string;
  division: string;
  emodnet_points: EmodnetPoint[] | null;
...
export type ApplicationType = "agriculture" | "cosmetics" | "environmental" |"humanConsumption" | "industrial" | "medicinal";
...
export const searchSpecies = {
  ...
  url(params: SearchPathParams): URL {
    const url = createApiUrl({
      pathname: searchSpecies.pathname(params),
    });
    return url;
  },
  options(): RequestOptions {
