...
export function GeoMapWrapper(props: GeoMapWrapperProps): JSX.Element {
  ...
  const data = {
    entities: Object.values(entities) as Array<Entity>,
    events: Object.values(events) as Array<Event>,
    missingEntityIds: [],
    missingEventIds: [],
    groupByEntities: [],
  };
  ...
  const mapStyle =
    window.matchMedia('(prefers-color-scheme: dark)').matches === true
      ? 'https://raw.githubusercontent.com/CartoDB/basemap-styles/refs/heads/master/mapboxgl/dark-matter.json'
