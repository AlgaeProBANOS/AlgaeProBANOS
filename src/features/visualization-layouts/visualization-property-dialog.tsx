...
export function ComponentPropertiesDialog(props: ComponentPropertiesDialogProps): JSX.Element {
  ...
  return (
    <DialogContent>
      ...
      <div>
        <div key={'gridTest'} className="grid size-auto grid-cols-[auto,auto] gap-4">
                          ...
                          return [
                            <div key={`entity${entity.id}`} className="flex h-7 items-center">
                              <CheckBox
                                ...
                                className="dark:border-neutral-600 dark:bg-neutral-700 dark:ring-offset-neutral-800 dark:focus:ring-blue-600 size-4 rounded border-neutral-300 bg-neutral-100 text-blue-600 focus:ring-2 focus:ring-blue-500"
                              />
                            </div>,
                            <div
                              ...
                              <Collapsible>
                                ...
                                <CollapsibleContent className="rounded-lg bg-blue-50 p-2 text-sm text-blue-900">
                                  {events.map((event: Event) => {
                                    newVisibilities[event.id] = newVisibilities[event.id] ?? true;
